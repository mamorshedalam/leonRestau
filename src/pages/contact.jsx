          ...
          <main>
               ...
               <div className="sl-container flex flex-wrap py-9">
                    <section className="xl:w-3/4 md:w-[70%] w-full xl:pr-5 md:pr-3 md:mb-0 mb-8">
                         ...
                         <p className="py-2 text-fuchsia-700"><strong>Fields marked (*) are required.</strong></p>
                         <form className="my-4">
                              <div className="mt-4">
                                   ...
                                   <input id="name" type="text" className="mt-3 p-1 w-full bg-white text-neutral-700 border-2 border-fuchsia-200/50 focus:border-fuchsia-700/50 rounded-md" />
                              </div>
                              <div className="mt-4">
                                   ...
                                   <input id="email" type="email" className="mt-3 p-1 w-full bg-white text-neutral-700 border-2 border-fuchsia-200/50 focus:border-fuchsia-700/50 rounded-md" />
                              </div>
                              <div className="mt-4">
                                   ...
                                   <textarea id="message" rows={10} className="mt-3 p-1 w-full bg-white text-neutral-700 border-2 border-fuchsia-200/50 focus:border-fuchsia-700/50 rounded-md" ></textarea>
                              </div>
                              <div className="mt-4">
                                   <button className="text-base text-white bg-fuchsia-700 uppercase font-bold tracking-widest py-2.5 px-5 rounded-md">submit</button>
                              </div>
                         </form>
                    </section>
                    <section className="xl:w-1/4 md:w-[30%] w-full xl:pl-5 md:pl-3">
                         <div className="mb-9">
                              <h3 className="font-black tracking-[2px] uppercase text-xs text-fuchsia-700 mb-2">Find Us On</h3>
                         ...
                         <div className="mb-9">
                              <h3 className="font-black tracking-[2px] uppercase text-xs text-fuchsia-700 mb-2">Address</h3>
                         ...
                         <div className="mb-9">
                              <h3 className="font-black tracking-[2px] uppercase text-xs text-fuchsia-700 mb-2">Telephone</h3>
                         ...
                         <div className="mb-9">
                              <h3 className="font-black tracking-[2px] uppercase text-xs text-fuchsia-700 mb-2">Email</h3>
                         ...
                         <div className="mb-9">
                              <h3 className="font-black tracking-[2px] uppercase text-xs text-fuchsia-700 mb-2">Open Hours</h3>
                              <span className="block space-x-1.5 leading-relaxed">Tuesday – Saturday: 12:00 – 22:00</span>
                         </div>
                         <div className="mb-9">
                              <h3 className="font-black tracking-[2px] uppercase text-xs text-fuchsia-700 mb-2">Online Reservation</h3>
                              <a href="" className="rounded-lg px-6 py-3 bg-fuchsia-700 text-white font-bold hover:bg-fuchsia-800">Make an Online Reservation</a>
