     ...
     return (
          <main>
               ...
               <section className="lg:py-8 py-5">
                    <div className="sl-container">
                         <h2 className="text-center lg:font-light uppercase mb-2.5 tracking-widest lg:text-3xl text-2xl">To <span className="lowercase text-fuchsia-700 font-courgette lg:text-5xl md:text-3xl text-2xl">Start</span></h2>
                         <div className="flex flex-wrap justify-center lg:mt-20 md:mt-12 mt-8 border-b border-neutral-800">
                              <div className="lg:w-1/3 md:w-1/2 w-full md:min-h-36 min-h-24 md:mb-9 mb-3 md:pr-[4%]">
                                   <h4 className="flex items-end font-semibold uppercase">
                                        <span className="text-fuchsia-700">Something To Nibble</span>
                                        <span className="flex-grow basis-0 border-b-2 border-dotted border-fuchsia-700/25"></span>
                                        <span>R115</span>
                                   </h4>
                              ...
                              <div className="lg:w-1/3 md:w-1/2 w-full md:min-h-36 min-h-24 md:mb-9 mb-3 md:pr-[4%]">
                                   <h4 className="flex items-end font-semibold uppercase">
                                        <span className="text-fuchsia-700">Asparagus</span>
                                        <span className="flex-grow basis-0 border-b-2 border-dotted border-fuchsia-700/25"></span>
                                        <span>R185</span>
                                   </h4>
                              ...
                              <div className="lg:w-1/3 md:w-1/2 w-full md:min-h-36 min-h-24 md:mb-9 mb-3 md:pr-[4%]">
                                   <h4 className="flex items-end font-semibold uppercase">
                                        <span className="text-fuchsia-700">Marble 'Avo Ritz'</span>
                                        <span className="flex-grow basis-0 border-b-2 border-dotted border-fuchsia-700/25"></span>
                                        <span>R175</span>
                                   </h4>
                              ...
                              <div className="lg:w-1/3 md:w-1/2 w-full md:min-h-36 min-h-24 md:mb-9 mb-3 md:pr-[4%]">
                                   <h4 className="flex items-end font-semibold uppercase">
                                        <span className="text-fuchsia-700">Overnight Coal Roasted Soup</span>
                                        <span className="flex-grow basis-0 border-b-2 border-dotted border-fuchsia-700/25"></span>
                                        <span>R115</span>
                                   </h4>
                              ...
                              <div className="lg:w-1/3 md:w-1/2 w-full md:min-h-36 min-h-24 md:mb-9 mb-3 md:pr-[4%]">
                                   <h4 className="flex items-end font-semibold uppercase">
                                        <span className="text-fuchsia-700">Marble Bites</span>
                                        <span className="flex-grow basis-0 border-b-2 border-dotted border-fuchsia-700/25"></span>
                                        <span>R205</span>
                                   </h4>
                              ...
                              <div className="lg:w-1/3 md:w-1/2 w-full md:min-h-36 min-h-24 md:mb-9 mb-3 md:pr-[4%]">
                                   <h4 className="flex items-end font-semibold uppercase">
                                        <span className="text-fuchsia-700">French Onion Soup</span>
                                        <span className="flex-grow basis-0 border-b-2 border-dotted border-fuchsia-700/25"></span>
                                        <span>R135</span>
                                   </h4>
               ...
               <section className="lg:py-8 py-5">
                    <div className="sl-container">
                         <h2 className="text-center lg:font-light uppercase mb-2.5 tracking-widest lg:text-3xl text-2xl">As An <span className="lowercase text-fuchsia-700 font-courgette lg:text-5xl md:text-3xl text-2xl">Extra</span></h2>
                         <div className="flex flex-wrap justify-center lg:mt-20 md:mt-12 mt-8 border-b border-neutral-800">
                              <div className="md:w-1/2 w-full md:min-h-20 min-h-16 md:mb-9 mb-3 md:pr-[4%]">
                                   <h4 className="flex items-end font-semibold uppercase">
                                        <span className="text-fuchsia-700">Grilled Chicken</span>
                                        <span className="flex-grow basis-0 border-b-2 border-dotted border-fuchsia-700/25"></span>
                                        <span>R95</span>
                                   </h4>
                              ...
                              <div className="md:w-1/2 w-full md:min-h-20 min-h-16 md:mb-9 mb-3 md:pr-[4%]">
                                   <h4 className="flex items-end font-semibold uppercase">
                                        <span className="text-fuchsia-700">Grilled Sirloin</span>
                                        <span className="flex-grow basis-0 border-b-2 border-dotted border-fuchsia-700/25"></span>
                                        <span>R110</span>
                                   </h4>
                                   <p className="w-3/4 text-neutral-700 mt-3"></p>
               ...
               <section className="lg:py-8 py-5">
                    <div className="sl-container">
                         <h2 className="text-center lg:font-light uppercase mb-2.5 tracking-widest lg:text-3xl text-2xl">The <span className="lowercase text-fuchsia-700 font-courgette lg:text-5xl md:text-3xl text-2xl">Works</span></h2>
                         <div className="flex flex-wrap justify-center lg:mt-20 md:mt-12 mt-8 border-b border-neutral-800">
                              <div className="lg:w-1/3 md:w-1/2 w-full md:min-h-36 min-h-24 md:mb-9 mb-3 md:pr-[4%]">
                                   <h4 className="flex items-end font-semibold uppercase">
                                        <span className="text-fuchsia-700">Roasted Calabash Cauliflower</span>
                                        <span className="flex-grow basis-0 border-b-2 border-dotted border-fuchsia-700/25"></span>
                                        <span>R215</span>
                                   </h4>
                              ...
                              <div className="lg:w-1/3 md:w-1/2 w-full md:min-h-36 min-h-24 md:mb-9 mb-3 md:pr-[4%]">
                                   <h4 className="flex items-end font-semibold uppercase">
                                        <span className="text-fuchsia-700">Pork</span>
                                        <span className="flex-grow basis-0 border-b-2 border-dotted border-fuchsia-700/25"></span>
                                        <span>R265</span>
                                   </h4>
                              ...
                              <div className="lg:w-1/3 md:w-1/2 w-full md:min-h-36 min-h-24 md:mb-9 mb-3 md:pr-[4%]">
                                   <h4 className="flex items-end font-semibold uppercase">
                                        <span className="text-fuchsia-700">Fillet</span>
                                        <span className="flex-grow basis-0 border-b-2 border-dotted border-fuchsia-700/25"></span>
                                        <span>R355</span>
                                   </h4>
                              ...
                              <div className="lg:w-1/3 md:w-1/2 w-full md:min-h-36 min-h-24 md:mb-9 mb-3 md:pr-[4%]">
                                   <h4 className="flex items-end font-semibold uppercase">
                                        <span className="text-fuchsia-700">Broccoli</span>
                                        <span className="flex-grow basis-0 border-b-2 border-dotted border-fuchsia-700/25"></span>
                                        <span>R235</span>
                                   </h4>
                              ...
                              <div className="lg:w-1/3 md:w-1/2 w-full md:min-h-36 min-h-24 md:mb-9 mb-3 md:pr-[4%]">
                                   <h4 className="flex items-end font-semibold uppercase">
                                        <span className="text-fuchsia-700">Seabass</span>
                                        <span className="flex-grow basis-0 border-b-2 border-dotted border-fuchsia-700/25"></span>
                                        <span>R335</span>
                                   </h4>
                              ...
                              <div className="lg:w-1/3 md:w-1/2 w-full md:min-h-36 min-h-24 md:mb-9 mb-3 md:pr-[4%]">
                                   <h4 className="flex items-end font-semibold uppercase">
                                        <span className="text-fuchsia-700">Salmon</span>
                                        <span className="flex-grow basis-0 border-b-2 border-dotted border-fuchsia-700/25"></span>
                                        <span>R355</span>
                                   </h4>
               ...
               <section className="lg:py-8 py-5">
                    <div className="sl-container">
                         <header className="text-center space-y-4">
                              <h2 className="lg:font-light uppercase mb-2.5 tracking-widest lg:text-3xl text-2xl">Our <span className="lowercase text-fuchsia-700 font-courgette lg:text-5xl md:text-3xl text-2xl">Signature</span> Meat Cuts</h2>
                         </header>
                         ...
                         <div className="flex flex-wrap justify-center lg:mt-20 md:mt-12 mt-8">
                              <div className="md:w-1/2 w-full md:min-h-16 min-h-12 md:pr-[4%]">
                                   <h4 className="flex items-end font-semibold uppercase">
                                        <span className="text-fuchsia-700">Sirloin on the Bone 750g</span>
                                        <span className="flex-grow basis-0 border-b-2 border-dotted border-fuchsia-700/25"></span>
                                        <span>R1 350</span>
                                   </h4>
                              ...
                              <div className="md:w-1/2 w-full md:min-h-16 min-h-12 md:pr-[4%]">
                                   <h4 className="flex items-end font-semibold uppercase">
                                        <span className="text-fuchsia-700">Prime Rib 750g</span>
                                        <span className="flex-grow basis-0 border-b-2 border-dotted border-fuchsia-700/25"></span>
                                        <span>R1 450</span>
                                   </h4>
                                   <p className="w-3/4 text-neutral-700 mt-3">42 day dry aged</p>
               ...
               <section className="lg:py-8 py-5">
                    <div className="sl-container">
                         <h2 className="text-center lg:font-light uppercase mb-2.5 tracking-widest lg:text-3xl text-2xl">A Tasting of our <span className="lowercase text-fuchsia-700 font-courgette lg:text-5xl md:text-3xl text-2xl">Sirloin</span> Selection</h2>
                         <div className="flex flex-wrap justify-center md:mt-12 mt-8">
                              <div className="md:w-1/2 w-full md:min-h-16 min-h-12 md:pr-[4%]">
                                   <h4 className="flex flex-col items-center gap-y-4 font-semibold uppercase">
                                        <span className="text-fuchsia-700">Chalmer Sirloin, Migo’s Jersey Sirloin and Silent Valley Wagyu Sirloin</span>
                                        <span>R2 450</span>
                                   </h4>
                                   <p className="w-3/4 text-neutral-700 mt-3"></p>
                              </div>
               ...
               <section className="lg:py-8 py-5">
                    <div className="sl-container">
                         <header className="text-center space-y-4">
                              <h2 className="lg:font-light uppercase mb-2.5 tracking-widest lg:text-3xl text-2xl"><span className="lowercase text-fuchsia-700 font-courgette lg:text-5xl md:text-3xl text-2xl">Silent Valley</span> Wagyu, Ingogo, South Africa</h2>
                         ...
                         <div className="flex flex-wrap justify-center lg:mt-20 md:mt-12 mt-8">
                              <div className="md:w-1/2 w-full md:min-h-16 min-h-12 md:pr-[4%]">
                                   <h4 className="flex items-end font-semibold uppercase">
                                        <span className="text-fuchsia-700">Rib-Eye 400g</span>
                                        <span className="flex-grow basis-0 border-b-2 border-dotted border-fuchsia-700/25"></span>
                                        <span>R1 490</span>
                                   </h4>
                                   <p className="w-3/4 text-neutral-700 mt-3"></p>
                              ...
                              <div className="md:w-1/2 w-full md:min-h-16 min-h-12 md:pr-[4%]">
                                   <h4 className="flex items-end font-semibold uppercase">
                                        <span className="text-fuchsia-700">Sirloin 300g</span>
                                        <span className="flex-grow basis-0 border-b-2 border-dotted border-fuchsia-700/25"></span>
                                        <span>R1 150</span>
                                   </h4>
                                   <p className="w-3/4 text-neutral-700 mt-3"></p>
               ...
               <section className="lg:py-8 py-5">
                    <div className="sl-container">
                         <header className="text-center space-y-4">
                              <h2 className="lg:font-light uppercase mb-2.5 tracking-widest lg:text-3xl text-2xl"><span className="lowercase text-fuchsia-700 font-courgette lg:text-5xl md:text-3xl text-2xl">Chalmar Beef</span>, South Africa</h2>
                         ...
                         <div className="flex flex-wrap justify-center lg:mt-20 md:mt-12 mt-8">
                              <div className="lg:w-1/3 md:w-1/2 w-full md:min-h-16 min-h-12 md:pr-[4%]">
                                   <h4 className="flex items-end font-semibold uppercase">
                                        <span className="text-fuchsia-700">Prime Rib 800g</span>
                                        <span className="flex-grow basis-0 border-b-2 border-dotted border-fuchsia-700/25"></span>
                                        <span>R585</span>
                                   </h4>
                              ...
                              <div className="lg:w-1/3 md:w-1/2 w-full md:min-h-16 min-h-12 md:pr-[4%]">
                                   <h4 className="flex items-end font-semibold uppercase">
                                        <span className="text-fuchsia-700">T-Bone 800G</span>
                                        <span className="flex-grow basis-0 border-b-2 border-dotted border-fuchsia-700/25"></span>
                                        <span>R595</span>
                                   </h4>
                                   <p className="w-3/4 text-neutral-700 mt-3">30 day wet aged</p>
                              ...
                              <div className="lg:w-1/3 md:w-1/2 w-full md:min-h-16 min-h-12 md:pr-[4%]">
                                   <h4 className="flex items-end font-semibold uppercase">
                                        <span className="text-fuchsia-700">Tomahawk 1kg</span>
                                        <span className="flex-grow basis-0 border-b-2 border-dotted border-fuchsia-700/25"></span>
                                        <span>R895</span>
                                   </h4>
                                   <p className="w-3/4 text-neutral-700 mt-3">30 day wet aged</p>
